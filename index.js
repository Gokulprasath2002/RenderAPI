...
app.post('/cancel-archive-order/:orderId', async (req, res) => {
  const orderId = req.params.orderId;
  const cancelEndpoint = `https://${domain}/admin/api/2023-04/orders/${orderId}/cancel.json`; // Endpoint to cancel the order
  const closeEndpoint = `https://${domain}/admin/api/2023-04/orders/${orderId}/close.json`;
  const archiveEndpoint = `https://${domain}/admin/api/2023-04/orders/${orderId}.json`; // Endpoint to archive the order
